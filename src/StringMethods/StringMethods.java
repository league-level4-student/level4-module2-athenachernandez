...
public class StringMethods {
	...
	public static String lineLeader(String s1, String s2, String s3) {
		...
		if (name1[1].compareTo(name2[1]) < 0) {
			if (name1[1].compareTo(name3[1]) < 0) {
				return s1;
			}
		}

		if (name2[1].compareTo(name1[1]) < 0) {
			if (name2[1].compareTo(name3[1]) < 0) {
				return s2;
			}
		}

		if (name3[1].compareTo(name1[1]) < 0) {
			if (name3[1].compareTo(name2[1]) < 0) {
				return s3;
			}
		}
		return null;
